...
public class TerrafortLauncher {
	...
	public static void main(String[] args) {
		if (LauncherUtilities.startNewJvmIfRequired())
			return;
		createApplication();
	}
	...
	private static Lwjgl3ApplicationConfiguration getDefaultConfiguration(final boolean fullscreen) {
		...
		configuration.setWindowIcon("icons/icon.png", "icons/icon.png", "icons/icon.png", "icons/icon.png");
